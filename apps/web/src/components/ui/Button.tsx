...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      ...
      secondary:
        'bg-dark-200 text-dark-900 hover:bg-dark-300 active:bg-dark-400 dark:bg-dark-800 dark:text-dark-50 dark:hover:bg-dark-700 dark:active:bg-dark-600',
      ...
      'action-edit': 'bg-blue-600 text-white hover:bg-blue-700 active:bg-blue-800',
      'action-delete': 'bg-red-600 text-white hover:bg-red-700 active:bg-red-800',
    }
