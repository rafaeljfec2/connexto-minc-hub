...
export function MonthNavigator({ month, year, onChange, className }: MonthNavigatorProps) {
  ...
  const filteredOptions = useMemo(() => {
    ...
    return monthYearOptions.filter(option => option.label.toLowerCase().includes(term))
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          isSelected && 'bg-primary-500/20 text-primary-600 dark:text-primary-400'
                        )}
                        type="button"
                      >
                        {option.label}
