...
export function NewConversationDropdown({
  ...
  return (
    <>
      ...
      <div className="fixed top-16 right-4 w-56 bg-white dark:bg-dark-800 rounded-lg shadow-lg border border-dark-200 dark:border-dark-700 z-50 overflow-hidden">
        <button
          onClick={() => {
            onNewChat()
            onClose()
